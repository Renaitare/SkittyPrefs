    ...
    if (self) {
        ...
        if (specifier.properties[@"twitter"]) {
            ...
            if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"twitter://"]]) {
                specifier.properties[@"url"] =
                    [@"twitter://user?screen_name=" stringByAppendingString:specifier.properties[@"twitter"]];
            } else {
                specifier.properties[@"url"] =
                    [@"https://mobile.twitter.com/" stringByAppendingString:specifier.properties[@"twitter"]];
            }
        }
...
- (void)openURL {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:self.specifier.properties[@"url"]]
                                       options:@{}
...
- (void)fetchImage {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      ...
      if (self.twitterUsername)
          url = [@"https://avatars.io/twitter/" stringByAppendingString:self.twitterUsername];
